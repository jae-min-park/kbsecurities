...
# token = '1767824468:AAFBSQzCNlzKCKVqYK7HlwqUlzDNqBibVdM'


# bot.send_message(chat_id = 1381723672, text="hello world")
import telegram
import datetime
...
caseList = ['10년입찰','30년입찰','3년입찰','5년입찰']
assetList = ['국채3년','국채10년', '3선','10선']
    ...
    for i, item in enumerate(texts):
        ...
        if i == 1 : 
            if item in assetList :
                ...
                context.bot.send_message(chat_id=update.effective_chat.id, text="/assets list에 있는 종목을 입력해 주세요")
        if i == 2 :
            offset = int(item)
            # else : 
